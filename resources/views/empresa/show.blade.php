    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('empresa.index')}}">{{$titleModal}}</a></li>
    ...
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="{{route('empresa.update', $registro->id)}}" method="post" id="formEditar">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nomeSocial" value="{{$registro->nomeSocial}}" maxlength="100" placeholder="" required />
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="rg_ie" value="{{$registro->rg_ie}}" maxlength="20" placeholder="">
                            </div>
                        </div>
                    </div>
        ...
        if (willDelete) {
            $.ajax({
                ...
                success: function(data){
                    ...
                    window.location.href = "{{url('/empresa')}}";
                },
                statusCode: {
                    404: function() {
