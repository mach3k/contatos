    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('regiao.index')}}">{{$titleModal}}</a></li>
    ...
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="{{route('regiao.update', $registro->id)}}" method="post" id="formEditar">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" data-select2-id="1">
                            <div class="form-group">
                                ...
                                <select name="pais_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" aria-hidden="true">
        ...
        if (willDelete) {
            $.ajax({
                ...
                success: function(data){
                    ...
                    window.location.href = "{{url('/regiao')}}";
                },
                statusCode: {
                    404: function() {
