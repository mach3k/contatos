    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('estado.index')}}">{{$titleModal}}</a></li>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <dl>
                        ...
                        <dt>País</dt>
                        @if(isset($registro->pais->nome))
                            <dd>{{$registro->pais->nome}}</dd>
                        @else
                            <dd>Não informado.</dd>
                        @endif
                    </div>
    ...
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="{{route('estado.update', $registro->id)}}" method="post" id="formEditar">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" data-select2-id="2">
                            <div class="form-group">
                                ...
                                <select name="regiao_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="2" aria-hidden="true">
                                    @foreach($regioes as $regiao)
                                        @if ($regiao->id == $registro->regiao_id)
                                        <option selected data-select2-id="{{$regiao->id}}" value="{{$regiao->id}}">{{$regiao->nome}}</option>
                                        @else
