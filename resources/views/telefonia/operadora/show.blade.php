    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('operadora.index')}}">{{$titleModal}}</a></li>
    ...
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="{{route('operadora.update', $registro->id)}}" method="post" id="formEditar">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="nome" value="{{$registro->nome}}" placeholder="Nome do registro..." tabindex="-1" autofocus required>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="number" class="form-control" name="codigo" value="{{$registro->codigo}}" min="1" max="9999" placeholder="">
                        </div>
                    </div>
                    </div>
                </form>
...
function deleteData(id){
    ...
    .then((willDelete) => {
        if (willDelete) {
            $.ajax({
                type: "POST",
                url: "{{url('/operadora')}}/" + id,
                data: {_method: 'delete'},
                success: function(data){
                    toastr.success("Registro excluído com sucesso.", "Feito!");
                    window.location.href = "{{url('/operadora')}}";
                },
                statusCode: {
                    404: function() {
