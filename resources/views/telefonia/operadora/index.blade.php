    ...
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="{{route('operadora.store')}}" method="post" id="formNovo">
                    {{csrf_field()}}
                    <div class="row">
                    <div class="col-sm-12">
                        <!-- text input -->
                        ...
                        <input type="text" class="form-control" name="nome" placeholder="Nome do registro..." tabindex="-1" autofocus required>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="number" class="form-control" name="codigo" min="1" max="9999">
                        </div>
                    </div>
                    </div>
                </form>
